	...
	IPLATUI.EFGrid = {
			"result" : {
				...
				beforeAdd: function (e) {
					...
					var url = IPLATUI.CONTEXT_PATH + "/web/DUHB1901?oprationType=" + oprationType;
...
showDetailED = function(envdeviceid){
  	 ...
  	 var url = IPLATUI.CONTEXT_PATH + "/web/DUHB1901?oprationType=" + oprationType + "&envdeviceid=" + envdeviceid;
  	 popWindow.data("kendoWindow").setOptions({
  	        open: function () {
  	        	popWindow.data("kendoWindow").refresh({
  	                url: url
...
showDetailFI = function(envdeviceid){
		...
		var url = IPLATUI.CONTEXT_PATH + "/web/DUHB1902?envdeviceid="+envdeviceid;
		popWindow.data("kendoWindow").setOptions({
			open: function() {
				popWindow.data("kendoWindow").refresh({
					url: url
...
showDetailDPI = function(envdeviceid){
		...
		var url = IPLATUI.CONTEXT_PATH + "/web/DUHB1903?envdeviceid="+envdeviceid;
		popWindow.data("kendoWindow").setOptions({
			open: function() {
				popWindow.data("kendoWindow").refresh({
					url: url
