	...
	IPLATUI.EFSelect = {
        "inqu_status-0-departid": {
            ...
            change: function (e) { //获取改变值
            	...
            	EiCommunicator.send("DUHB1903","queryProcedureByDepart",eiInfo, {
	...
	EiCommunicator.send("DUHB1803", "loadMsg", ei, {
		onSuccess: function(ei) {
			...
			if (status == 1) {
				...
				IPLAT.EFSelect.value($("#inqu_status-0-status"),ei.get("status"));
				...
				$("#inqu_status-0-signform").val(ei.get("signform"));
