		...
		<div class="col-md-12">
			...
			<EF:EFRegion id="result" title="记录集" fitHeight="true">
				<EF:EFGrid blockId="result" autoDraw="false" sort="single">
					...
					<EF:EFColumn ename="facilitycode" cname="污染防治设施编号" width="150" enable="false" />
					...
					<EF:EFColumn ename="facilitytype" cname="污染防治设施类型" width="150" enable="false" />
					...
					<EF:EFColumn ename="controllermodel" cname="变频器型号/容量"  enable="false" />
