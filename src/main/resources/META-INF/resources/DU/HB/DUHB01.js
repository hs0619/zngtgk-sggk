	...
	IPLATUI.EFGrid = {
			"result" : {
				...
				beforeAdd: function (e) {
					...
					var url = IPLATUI.CONTEXT_PATH + "/web/DUHB02?oprationType=" + oprationType + "&parentid=" + parentid;
...
showDetail = function(departmentId){
  	 ...
  	 var url = IPLATUI.CONTEXT_PATH + "/web/DUHB02?oprationType=" + oprationType + "&departmentId=" + departmentId;
  	 popWindow.data("kendoWindow").setOptions({
  	        open: function () {
  	        	popWindow.data("kendoWindow").refresh({
  	                url: url
