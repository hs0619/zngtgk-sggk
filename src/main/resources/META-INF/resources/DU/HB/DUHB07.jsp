		...
		<div class="col-md-12">
			<EF:EFRegion id="inqu" title="查询条件" type="query"
				...
				<div class="row">
					...
					<EF:EFSelect ename="inqu_status-0-status" cname="是否使用" colWidth="4">
						<EF:EFOption label="全部" value="" />
				...
				<div class="row">
					...
					<EF:EFSelect ename="inqu_status-0-procid" cname="工序"   colWidth="4">
						<EF:EFOption label="全部" value="" />
				...
				<div class="row">
				<EF:EFSelect ename="inqu_status-0-isonline" cname="人工/在线" colWidth="4">
					<EF:EFOption label="全部" value="" />
					<EF:EFOption label="人工" value="0" />
					<EF:EFOption label="在线" value="1" />
				</EF:EFSelect>
			...
			<EF:EFRegion id="result" title="记录集"  fitHeight="true" >
				<EF:EFGrid blockId="result" autoDraw="false" sort="setted" rowNo="true">
					...
					<EF:EFColumn ename="dischargeportcode" cname="排口编号" />
...
<%--					<EF:EFColumn ename="sort" cname="排序" />--%>
				...
				<EF:EFWindow id="showSI" refresh="true">
				</EF:EFWindow>
				<EF:EFWindow id="showSF" refresh="true">
				</EF:EFWindow>
			</EF:EFRegion>
