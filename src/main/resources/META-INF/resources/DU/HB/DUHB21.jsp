	...
	<div class="row">
		<div class="col-md-12">
			<EF:EFRegion id="inqu" title="查询条件" type="query" efRegionShowClear="true" efRegionSave="true">
				...
				<div class="row">
					<EF:EFInput ename="inqu_status-0-facilitycode" cname="污染防治设施编号" colWidth="4" />
					<EF:EFInput ename="inqu_status-0-facilityname" cname="污染防治设施名称" colWidth="4" />
				</div>
			</EF:EFRegion>
			<EF:EFRegion id="result" title="记录集" fitHeight="true">
				<EF:EFGrid blockId="result" autoDraw="false" sort="single" rowNo="true">
					...
					<EF:EFColumn ename="operation" cname="操作" enable="false" width="90" locked="true" />
					...
					<EF:EFComboColumn ename="procedureid" cname="工序"
						...
						valueProperty="departmentId" textField="departmentName"
						valueField="departmentId" />
					<EF:EFColumn ename="facilitycode" cname="污染防治设施编号" enable="false" width="150"/>
					<EF:EFColumn ename="facilityname" cname="污染防治设施名称" width="150" enable="false" />
					<EF:EFColumn ename="mark" cname="备注" enable="false" width="220"/>
					...
					<EF:EFColumn ename="handability" cname="设计处理能力（m3/h）" enable="false" width="180"/>
				...
				<EF:EFWindow id="showFI" width="80%" height="90%" refresh="true">
				</EF:EFWindow>
				
				<EF:EFWindow id="showSBI" width="80%" height="90%" refresh="true">
				</EF:EFWindow>
			</EF:EFRegion>
