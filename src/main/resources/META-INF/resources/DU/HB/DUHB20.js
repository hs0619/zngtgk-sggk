    ...
    IPLATUI.EFSelect = {
        "inqu_status-0-departmentid": {
            ...
            change: function(e) { //获取改变值
                ...
                EiCommunicator.send("DUHB20", "getProcedureByDepartid", eiInfo, {
	...
	IPLATUI.EFGrid = {
			"result" : {
				...
				beforeAdd: function (e) {
					...
					var url = IPLATUI.CONTEXT_PATH + "/web/DUHB2001?oprationType=" + oprationType;
...
showDetail = function(facilityid,departmentid){
  	 ...
  	 var url = IPLATUI.CONTEXT_PATH + "/web/DUHB2001?oprationType=" + oprationType + "&facilityid=" + facilityid+ "&departmentid=" + departmentid;
  	 popWindow.data("kendoWindow").setOptions({
  	        open: function () {
  	        	popWindow.data("kendoWindow").refresh({
  	                url: url
...
function showSheBeiInfo(facilityid){
	 var popWindow = $("#showSBI");
  	 var url = IPLATUI.CONTEXT_PATH + "/web/DUHB2002?facilityid=" + facilityid;
  	 popWindow.data("kendoWindow").setOptions({
  	        open: function () {
  	        	popWindow.data("kendoWindow").refresh({
  	                url: url
