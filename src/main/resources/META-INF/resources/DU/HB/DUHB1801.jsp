...
<EF:EFPage >
   <EF:EFRegion id="inqu" title="排污节点信息编辑" type="query" efRegionShowClear="true" efRegionSave="true">
       ...
       <div class="row divtop">
            <div class="col-xs-6 divcol">
                 <EF:EFInput ename="inqu_status-0-processid" readonly="true" cname="污染治理设施编号" colWidth="12" />
            </div>
            <div class="col-xs-6 divcol">
                 <EF:EFInput ename="inqu_status-0-processname" readonly="true" cname="污染治理设施名称" colWidth="12" />
            </div>
       </div>
