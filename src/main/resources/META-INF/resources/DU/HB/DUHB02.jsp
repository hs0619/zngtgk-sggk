...
<EF:EFPage >
   <EF:EFRegion id="inqu" title="厂部信息" type="query" efRegionShowClear="true" efRegionSave="true">
	   <hr>
	   <div class="row">
	        <div class="col-xs-6">
                 <EF:EFInput ename="inqu_status-0-departmentId"  cname="厂部ID" colWidth="12" disabled="true"/> 
            </div>
            <div class="col-xs-6">
                 <EF:EFInput ename="inqu_status-0-departmentName"  cname="厂部名称" colWidth="12" required="true"/> 
            </div>
        </div>
        <hr>
       <div class="row">
            <div class="col-xs-6">
                <EF:EFSelect ename="inqu_status-0-parentid"  cname="所属厂部" colWidth="12" required="true" disabled="true"> </EF:EFSelect>
            </div>
            <div class="col-xs-6">
       ...
       <div class="row">
			<div class="col-xs-6">
                 <EF:EFInput ename="inqu_status-0-level" cname="等级" colWidth="12" required="true"/>
            </div>
            <div class="col-xs-6">
       ...
       <hr>
        <div class="row">
			<div class="col-xs-6">
                 <EF:EFInput ename="inqu_status-0-totalplan" cname="标志位" colWidth="12" />
            </div>
       </div>
        <hr>
        <div class="row">
