...
<div class="row">
       <div class="col-md-3">
            <EF:EFTree  bindId="departmentTree" ename="departmentId" textField="text" valueField="label" hasChildren="leaf"
                           serviceName="DUHB0201" methodName="query" style="height:550px;" >
            </EF:EFTree>       
       </div>
       <div class="col-md-9">
           <EF:EFRegion id="inqu" title="查询条件" type="query" efRegionShowClear="true" efRegionSave="true">
		        <div class="row">
		            <EF:EFInput ename="inqu_status-0-parentid" cname="所属厂部ID" colWidth="4" disabled="true"/> 
		            <%-- <EF:EFInput ename="inqu_status-0-parentname" cname="所属厂部" colWidth="4" /> --%>
                    <EF:EFInput ename="inqu_status-0-departmentName" cname="工序名称" colWidth="4"/>
                </div>
			 </EF:EFRegion>
			 <EF:EFRegion id="result" title="记录集">
		        <EF:EFGrid blockId="result" autoDraw="false"  sort="setted">
		        	...
		        	<EF:EFColumn ename="departmentName" cname="工序名称" enable="false"/>
		        	<EF:EFColumn ename="parentname" cname="所属厂部" enable="false"/>
		        	<EF:EFComboColumn ename="type" cname="类型" blockName="typeList" labelProperty="typename" valueProperty="typeid" textField="typename" valueField="typeid" />
		        	...
		        	<EF:EFComboColumn ename="status" cname="是否启用" blockName="flagList" labelProperty="flagname" valueProperty="flagid" textField="flagname" valueField="flagid" />
		        </EF:EFGrid> 
