...
* 
*/
public class Tduhf6801 extends DaoEPBase {
    ...
    public void initMetaData() {
        ...
        eiColumn = new EiColumn("uploadid");
        eiColumn.setFieldLength(100);
        eiColumn.setDescName(" ");
        eiMetadata.addMeta(eiColumn);
    }
    ...
    public void fromMap(Map map) {
        ...
        setUploadid(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("uploadid")), uploadid));
    }
    ...
    public Map toMap() {
        ...
        map.put("uploadid", StringUtils.toString(uploadid, eiMetadata.getMeta("uploadid")));
        return map;
    }
}