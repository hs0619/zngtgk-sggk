...
* 
*/
public class Tduhb20 extends DaoEPBase {
    ...
    public void initMetaData() {
        ...
        eiColumn = new EiColumn("handabilityAct");
        eiColumn.setFieldLength(255);
        eiColumn.setDescName(" ");
        eiMetadata.addMeta(eiColumn);

        eiColumn = new EiColumn("devicearea");
        eiColumn.setFieldLength(255);
        eiColumn.setDescName(" ");
        eiMetadata.addMeta(eiColumn);

        eiColumn = new EiColumn("deviceflow");
        eiColumn.setFieldLength(255);
        eiColumn.setDescName(" ");
        eiMetadata.addMeta(eiColumn);
        ...
        eiColumn = new EiColumn("craft");
        eiColumn.setFieldLength(255);
        eiColumn.setDescName(" ");
        eiMetadata.addMeta(eiColumn);

        eiColumn = new EiColumn("filter");
        eiColumn.setFieldLength(255);
        eiColumn.setDescName(" ");
        eiMetadata.addMeta(eiColumn);
    ...
    /**
     * get the handabilityAct 
     * @return the handabilityAct
     */
    public String getHandabilityAct() {
        return this.handabilityAct;
    }

    /**
     * set the handabilityAct 
     */
    public void setHandabilityAct(String handabilityAct) {
        this.handabilityAct = handabilityAct;
    }

    /**
     * get the devicearea 
     * @return the devicearea
     */
	...
	public void fromMap(Map map) {
        ...
        setHandabilityAct(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("handabilityAct")), handabilityAct));
        setDevicearea(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("devicearea")), devicearea));
        setDeviceflow(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("deviceflow")), deviceflow));
        setDevicenames(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("devicenames")), devicenames));

        setCraft(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("craft")), craft));
        setFilter(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("filter")), filter));
        setDevicenames(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("mark")), mark));
    ...
    public Map toMap() {
        ...
        map.put("handabilityAct", StringUtils.toString(handabilityAct, eiMetadata.getMeta("handabilityAct")));
        map.put("devicearea", StringUtils.toString(devicearea, eiMetadata.getMeta("devicearea")));
        map.put("deviceflow", StringUtils.toString(deviceflow, eiMetadata.getMeta("deviceflow")));
        map.put("devicenames", StringUtils.toString(devicenames, eiMetadata.getMeta("devicenames")));

        map.put("craft", StringUtils.toString(craft, eiMetadata.getMeta("craft")));
        map.put("filter", StringUtils.toString(filter, eiMetadata.getMeta("filter")));
