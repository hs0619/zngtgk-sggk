...
* 
*/
public class Tduhf05 extends DaoEPBase {
    ...
    private String loginName_userName = " ";
    ...
    public void initMetaData() {
        ...
        eiColumn = new EiColumn("loginName_userName");
        eiColumn.setFieldLength(32);
        eiColumn.setDescName("");
        eiMetadata.addMeta(eiColumn);
    }
    ...
    public String getLoginName_userName() {
		return loginName_userName;
	}

	public void setLoginName_userName(String loginName_userName) {
		this.loginName_userName = loginName_userName;
	}
    ...
    public void fromMap(Map map) {
        ...
        setLoginName_userName(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("loginName_userName")), loginName_userName));
    }
    ...
    public Map toMap() {
        ...
        map.put("loginName_userName", StringUtils.toString(loginName_userName, eiMetadata.getMeta("loginName_userName")));
        return map;
    }
}